...
* GitHub Issues: <https://github.com/nfub/hello-world/issues>
...
* nfub/hello-world follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  nfub/hello-world automatically runs tests for pull requests. However,
...
[github]: https://github.com/nfub/hello-world
[issues]: https://github.com/nfub/hello-world/issues
[pull requests]: https://github.com/nfub/hello-world/pulls
